        ...
        <link rel="icon" href="/static/roliglek/2021/cropped-webbplatsikon-roliglek-150x150.png" />
            ...
            <section className="grid leading-4 place-items-center">
                ...
                <div className="p-4 grid gap-4 grid-cols-3 xs:grid-cols-4  ">
                    ...
                    <p className=" hidden xs:block row-start-2 bg-slate-500 col-span-2 self-center md:pr-12 md:text-lg"> ...vi älskar rörelse och gemenskap! Vår vision är en vardag och fritid där vi rör oss mycket, och gör roliga saker tillsammans</p>
                    ...
                    <div className=" bg-blue-500 h-auto square col-start-2 "></div>
                    <div className=" bg-pink-500 h-auto square "></div>
                    ...
                    <p className=" col-span-2 ">  Välkommen till en roligare vardag och fest! </p>
