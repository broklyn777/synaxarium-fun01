...
lastmod: "2022-06-02"
category: "Tailwind"
description: "Looking for a performant, out of the box template, with all the best in web technology to support your blogging needs?"
thumbnailUrl: "/image/dev/tailwind-01.png"
author: ""
---

## Tailwind CSS Trix

#### Tailwind opposite of hidden

```css

/* As far as i know the hidden class sets the element to display:
none so you could set it to any other display value like block or flex. */

<div class="sm:hidden md:block">// my content</div>
